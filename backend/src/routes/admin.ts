...
import { parseScorecardUrl, type ScorecardStat } from '../services/scorecard.service.js'
...
export async function adminRoutes(app: FastifyInstance): Promise<void> {
  // GET /admin/settings — all ipl_weeks + system settings
  ...
  app.patch<{ Params: { weekNum: string } }>('/admin/weeks/:weekNum', async (req, reply) => {
    ...
    // Enforce only one live week at a time
